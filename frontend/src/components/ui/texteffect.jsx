...
const AnimationComponent = memo(({ segment, variants, per, segmentWrapperClassName }) => {
  const content =
    per === 'line' ? (
      <motion.motion.span variants={variants} className="block">
        {segment}
      </motion.motion.span>
    ) : per === 'word' ? (
      <motion.motion.span
      ...
      <motion.motion.span className="inline-block whitespace-pre">
...
export function TextEffect({
  ...
  const MotionTag = motion.motion[as] || motion.motion.p;
